...
public class OrderService : IOrderService
{
  ...
  //                                               ProductCategoryName = _salesManagementDbContext.ProductCategories.FirstOrDefault ( c => c.Id == salesManagementDbContext.Products.FirstOrDefault ( p => p.Id == oi.ProductId ).CategoryId ).Name,
  ...
  //                                               RetailOutletLocation = _salesManagementDbContext.RetailOutlets.FirstOrDefault ( r => r.Id == salesManagementDbContext.Clients.FirstOrDefault ( c => c.Id == order.ClientId ).RetailOutletId ).Location
  //                                             } ).ToListAsync ();
